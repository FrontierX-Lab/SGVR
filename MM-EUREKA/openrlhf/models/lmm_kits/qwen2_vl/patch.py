...
class Qwen2_VLPatch(BasePatch):
    def _add_get_inputs_embeds():
            ...
            **kwargs,
            ...
            if pixel_values is not None:
                ...
                if n_image_tokens != n_image_features:
                    print(f"警告: 视觉特征与token不匹配 (tokens: {n_image_tokens}, features: {n_image_features})，跳过视觉处理")
        ...
        Qwen2VLForConditionalGeneration.get_inputs_embeds = get_inputs_embeds
    ...
    def _add_get_position_ids():
        ...
        Qwen2VLForConditionalGeneration.get_position_ids = get_position_ids
    ...
    def _add_offset_split_position_ids():
        ...
        Qwen2VLForConditionalGeneration.offset_split_position_ids = offset_split_position_ids
