...
class Qwen3_VLPatch(BasePatch):
    def _add_get_inputs_embeds():
        try:
            from transformers import Qwen3VLForConditionalGeneration  # type: ignore
        except Exception:
            # 旧版 transformers 无该类，直接跳过
            return
        ...
        Qwen3VLForConditionalGeneration.get_inputs_embeds = get_inputs_embeds  # type: ignore
    ...
    def _add_get_position_ids():
        ...
        Qwen3VLForConditionalGeneration.get_position_ids = get_position_ids  # type: ignore
    ...
    def _add_offset_split_position_ids():
        ...
        Qwen3VLForConditionalGeneration.offset_split_position_ids = offset_split_position_ids  # type: ignore
